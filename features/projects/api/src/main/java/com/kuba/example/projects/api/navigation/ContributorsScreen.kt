...
class ContributorsScreen(ownerLogin: String, repoName: String, repoDescription: String?) :
    ...
    companion object {
        ...
        fun extractArgs(savedStateHandle: SavedStateHandle) =
            savedStateHandle.get<ContributorScreenArgs>(KEY_ARGS)!!
